...
// news.length displayed 
displayPage(news, 'all');
displayed = news.length;
...
checkEl.addEventListener('change', function () 
{
    ...
    if (this.checked) 
    {
        ...
        for (let i = 0; i < newsBookmarked.length; i++) 
        {
            ...
            // Se la selct è all si mostra in pagina e si incrementa displayed
            if (text === 'all') 
            {
            ...
            else 
            {
                ...
                for (let j = 0; j < tags.length; j++) 
                {
                    ...
                    // si mostra in pagina e si incrementa displayed
                    if (tags[j] === text) 
                    {
                        displayNewsInSelect(obj);
                        displayed++;
